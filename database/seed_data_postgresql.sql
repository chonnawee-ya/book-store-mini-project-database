-- ==============================================================================
-- Seed Data Script for PostgreSQL / Supabase
-- ==============================================================================
...
(1, 1, 1, 'Clean Code: A Handbook of Agile Software Craftsmanship', 'แนวทางการเขียนโค้ดให้อ่านง่าย บำรุงรักษาสะดวก และมีประสิทธิภาพสูงสุด', 450.0, 'https://images.unsplash.com/photo-1532012164546-f432f2e3777a?w=400&q=80', '/download/ebook/1', TRUE, '2026-09-22 20:02:00'),
(2, 1, 4, 'Database Systems & SQL Mastery', 'เจาะลึกโครงสร้างฐานข้อมูลเชิงสัมพันธ์ 3NF Indexing และ Query Optimization', 520.0, 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=400&q=80', '/download/ebook/2', TRUE, '2026-09-22 20:02:00'),
(3, 1, 7, 'Refactoring: Improving the Design of Existing Code', 'เทคนิคการปรับปรุงโค้ดเดิมให้มีสถาปัตยกรรมที่ยืดหยุ่น ปลอดภัย และทดสอบง่าย', 490.0, 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=400&q=80', '/download/ebook/3', TRUE, '2026-09-22 20:02:00'),
(4, 2, 2, 'Atomic Habits: เพราะชีวิตดีได้กว่าที่เป็น', 'เปลี่ยนชีวิตด้วยพลังแห่งการปรับนิสัยวันละ 1% ที่สร้างผลลัพธ์มหาศาล', 290.0, 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=400&q=80', '/download/ebook/4', TRUE, '2026-09-22 20:02:00'),
(5, 3, 3, 'The Psychology of Money: จิตวิทยาว่าด้วยเงิน', 'บทเรียนเหนือกาลเวลาเรื่องความมั่งคั่ง ความโลภ และความสุข', 350.0, 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=400&q=80', '/download/ebook/5', TRUE, '2026-09-22 20:02:00'),
(6, 4, 6, '1984: นิยายดิสโทเปียระดับตำนาน', 'เรื่องราวโลกอนาคตที่ Big Brother กำลังจับตามองคุณอยู่ทุกฝีก้าว', 220.0, 'https://images.unsplash.com/photo-1543002588-bfa74002ed7e?w=400&q=80', '/download/ebook/6', TRUE, '2026-09-22 20:02:00'),
(7, 5, 5, 'The Design of Everyday Things', 'ทำไมของบางอย่างใช้ง่าย บางอย่างใช้ยาก คัมภีร์ UX ที่นักออกแบบทุกคนต้องอ่าน', 380.0, 'https://images.unsplash.com/photo-1507842229458-5742130e6677?w=400&q=80', '/download/ebook/7', TRUE, '2026-09-22 20:02:00'),
(8, 3, 8, 'Money 101: เริ่มต้นสร้างอิสรภาพทางการเงิน', 'คู่มือวางแผนการเงินฉบับเข้าใจง่ายสำหรับคนทำงานและวัยรุ่นยุคใหม่', 250.0, 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=400&q=80', '/download/ebook/8', TRUE, '2026-09-22 20:02:00'),
(9, 1, 1, 'The Clean Coder: Code of Conduct for Professional Programmers', 'จรรยาบรรณ วินัย และทัศนคติของโปรแกรมเมอร์มืออาชีพ', 390.0, 'https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?w=400&q=80', '/download/ebook/9', TRUE, '2026-09-22 20:02:00'),
(10, 2, 2, 'Deep Work: กฎเหล็กแห่งการจดจ่อในโลกที่ถูกรบกวน', 'สร้างสมาธิขั้นสุดเพื่อผลลัพธ์การทำงานที่ทรงคุณค่าและเหนือชั้น', 310.0, 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=400&q=80', '/download/ebook/10', TRUE, '2026-09-22 20:02:00'),
(11, 4, 6, 'Animal Farm: การเมืองในฟาร์มสัตว์', 'วรรณกรรมเสียดสีอำนาจเผด็จการผ่านมุมมองของเหล่าสัตว์ในฟาร์ม', 180.0, 'https://images.unsplash.com/photo-1476275466078-4007374efbbe?w=400&q=80', '/download/ebook/11', TRUE, '2026-09-22 20:02:00'),
(12, 5, 5, 'Don''t Make Me Think: คัมภีร์ออกแบบ Web Usability', 'หลักการออกแบบเว็บและแอปพลิเคชันให้ผู้ใช้เข้าใจได้ในทันทีโดยไม่ต้องคิด', 360.0, 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?w=400&q=80', '/download/ebook/12', TRUE, '2026-09-22 20:02:00'),
(13, 1, 7, 'Building Microservices: Designing Fine-Grained Systems', 'สถาปัตยกรรม Microservices การแบ่งขอบเขต Service และการประสานงาน', 590.0, 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&q=80', '/download/ebook/13', TRUE, '2026-09-22 20:02:00'),
(14, 3, 3, 'Same as Ever: คู่มือทำความเข้าใจสิ่งที่ไม่เคยเปลี่ยน', 'มองทะลุอนาคตด้วยความเข้าใจพฤติกรรมมนุษย์และสิ่งที่ไม่เคยเปลี่ยนแปลงตามกาลเวลา', 320.0, 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400&q=80', '/download/ebook/14', TRUE, '2026-09-22 20:02:00'),
(15, 1, 4, 'Algorithms Unlocked: ไขรหัสอัลกอริทึมฉบับย่อยง่าย', 'เข้าใจแนวคิดอัลกอริทึมพื้นฐานที่ขับเคลื่อนเทคโนโลยีรอบตัวคุณ', 410.0, 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=400&q=80', '/download/ebook/15', TRUE, '2026-09-22 20:02:00'),
(16, 2, 2, 'Thinking, Fast and Slow (ฉบับ E-Book พิเศษ)', 'ระบบการคิดเร็วและการคิดช้าที่ชี้นำการตัดสินใจของมนุษย์ทุกคน', 420.0, 'https://images.unsplash.com/photo-1457369804613-52c61a468e7d?w=400&q=80', '/download/ebook/16', FALSE, '2026-09-22 20:02:00');
...
-- Synchronize PostgreSQL sequence values after manual ID inserts
